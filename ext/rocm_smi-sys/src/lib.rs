...
impl rsmi_init_flags_t {
    ...
    pub const RSMI_INIT_FLAG_THRAD_ONLY_MUTEX: rsmi_init_flags_t =
        rsmi_init_flags_t(288230376151711744);
}
impl rsmi_init_flags_t {
    ///!< Reserved for test
    pub const RSMI_INIT_FLAG_RESRV_TEST1: rsmi_init_flags_t = rsmi_init_flags_t(576460752303423488);
}
#[repr(transparent)]
...
impl rsmi_evt_notification_type_t {
    ///!< Unused
    pub const RSMI_EVT_NOTIF_NONE: rsmi_evt_notification_type_t = rsmi_evt_notification_type_t(0);
}
impl rsmi_evt_notification_type_t {
    ///!< VM page fault
...
impl rsmi_evt_notification_type_t {
    pub const RSMI_EVT_NOTIF_EVENT_MIGRATE_START: rsmi_evt_notification_type_t =
        rsmi_evt_notification_type_t(5);
}
impl rsmi_evt_notification_type_t {
    pub const RSMI_EVT_NOTIF_EVENT_MIGRATE_END: rsmi_evt_notification_type_t =
        rsmi_evt_notification_type_t(6);
}
impl rsmi_evt_notification_type_t {
    pub const RSMI_EVT_NOTIF_EVENT_PAGE_FAULT_START: rsmi_evt_notification_type_t =
        rsmi_evt_notification_type_t(7);
}
impl rsmi_evt_notification_type_t {
    pub const RSMI_EVT_NOTIF_EVENT_PAGE_FAULT_END: rsmi_evt_notification_type_t =
        rsmi_evt_notification_type_t(8);
}
impl rsmi_evt_notification_type_t {
    pub const RSMI_EVT_NOTIF_EVENT_QUEUE_EVICTION: rsmi_evt_notification_type_t =
        rsmi_evt_notification_type_t(9);
}
impl rsmi_evt_notification_type_t {
    pub const RSMI_EVT_NOTIF_EVENT_QUEUE_RESTORE: rsmi_evt_notification_type_t =
        rsmi_evt_notification_type_t(10);
}
impl rsmi_evt_notification_type_t {
    pub const RSMI_EVT_NOTIF_EVENT_UNMAP_FROM_GPU: rsmi_evt_notification_type_t =
        rsmi_evt_notification_type_t(11);
}
impl rsmi_evt_notification_type_t {
    pub const RSMI_EVT_NOTIF_EVENT_ALL_PROCESS: rsmi_evt_notification_type_t =
        rsmi_evt_notification_type_t(64);
}
impl rsmi_evt_notification_type_t {
    pub const RSMI_EVT_NOTIF_LAST: rsmi_evt_notification_type_t = rsmi_evt_notification_type_t(64);
}
#[repr(transparent)]
...
impl rsmi_compute_partition_type_t {
    pub const RSMI_COMPUTE_PARTITION_INVALID: rsmi_compute_partition_type_t =
        rsmi_compute_partition_type_t(0);
}
impl rsmi_compute_partition_type_t {
    /**!< Single GPU mode (SPX)- All XCCs work
    !< together with shared memory*/
    pub const RSMI_COMPUTE_PARTITION_SPX: rsmi_compute_partition_type_t =
        rsmi_compute_partition_type_t(1);
}
impl rsmi_compute_partition_type_t {
    /**!< Dual GPU mode (DPX)- Half XCCs work
    !< together with shared memory*/
    pub const RSMI_COMPUTE_PARTITION_DPX: rsmi_compute_partition_type_t =
        rsmi_compute_partition_type_t(2);
}
impl rsmi_compute_partition_type_t {
    /**!< Triple GPU mode (TPX)- One-third XCCs
    !< work together with shared memory*/
    pub const RSMI_COMPUTE_PARTITION_TPX: rsmi_compute_partition_type_t =
        rsmi_compute_partition_type_t(3);
}
impl rsmi_compute_partition_type_t {
    /**!< Quad GPU mode (QPX)- Quarter XCCs
    !< work together with shared memory*/
    pub const RSMI_COMPUTE_PARTITION_QPX: rsmi_compute_partition_type_t =
        rsmi_compute_partition_type_t(4);
}
impl rsmi_compute_partition_type_t {
    /**!< Core mode (CPX)- Per-chip XCC with
    !< shared memory*/
    pub const RSMI_COMPUTE_PARTITION_CPX: rsmi_compute_partition_type_t =
        rsmi_compute_partition_type_t(5);
}
#[repr(transparent)]
...
impl rsmi_memory_partition_type_t {
    pub const RSMI_MEMORY_PARTITION_UNKNOWN: rsmi_memory_partition_type_t =
        rsmi_memory_partition_type_t(0);
}
impl rsmi_memory_partition_type_t {
    /**!< NPS1 - All CCD & XCD data is interleaved
    !< accross all 8 HBM stacks (all stacks/1).*/
    pub const RSMI_MEMORY_PARTITION_NPS1: rsmi_memory_partition_type_t =
        rsmi_memory_partition_type_t(1);
}
impl rsmi_memory_partition_type_t {
...
impl rsmi_error {
    ...
    pub const r#AMDGPU_RESTART_ERR: rsmi_error =
        rsmi_error(unsafe { ::core::num::NonZeroU32::new_unchecked(19) });
    pub const r#DRM_ERROR: rsmi_error =
        rsmi_error(unsafe { ::core::num::NonZeroU32::new_unchecked(20) });
    pub const r#UNKNOWN_ERROR: rsmi_error =
        rsmi_error(unsafe { ::core::num::NonZeroU32::new_unchecked(4294967295) });
}
#[repr(transparent)]
...
pub trait rsmi_status_tConsts {
    ...
    const ERROR_INVALID_ARGS: rsmi_status_t = rsmi_status_t::Err(rsmi_error::r#INVALID_ARGS);
    ...
    const ERROR_OUT_OF_RESOURCES: rsmi_status_t =
        rsmi_status_t::Err(rsmi_error::r#OUT_OF_RESOURCES);
    const ERROR_INTERNAL_EXCEPTION: rsmi_status_t =
        rsmi_status_t::Err(rsmi_error::r#INTERNAL_EXCEPTION);
    const ERROR_INPUT_OUT_OF_BOUNDS: rsmi_status_t =
        rsmi_status_t::Err(rsmi_error::r#INPUT_OUT_OF_BOUNDS);
    const ERROR_INIT_ERROR: rsmi_status_t = rsmi_status_t::Err(rsmi_error::r#INIT_ERROR);
    const ERROR_IZATION_ERROR: rsmi_status_t = rsmi_status_t::Err(rsmi_error::r#IZATION_ERROR);
    const ERROR_NOT_YET_IMPLEMENTED: rsmi_status_t =
        rsmi_status_t::Err(rsmi_error::r#NOT_YET_IMPLEMENTED);
    const ERROR_NOT_FOUND: rsmi_status_t = rsmi_status_t::Err(rsmi_error::r#NOT_FOUND);
    const ERROR_INSUFFICIENT_SIZE: rsmi_status_t =
        rsmi_status_t::Err(rsmi_error::r#INSUFFICIENT_SIZE);
    const ERROR_INTERRUPT: rsmi_status_t = rsmi_status_t::Err(rsmi_error::r#INTERRUPT);
    const ERROR_UNEXPECTED_SIZE: rsmi_status_t = rsmi_status_t::Err(rsmi_error::r#UNEXPECTED_SIZE);
    const ERROR_NO_DATA: rsmi_status_t = rsmi_status_t::Err(rsmi_error::r#NO_DATA);
    const ERROR_UNEXPECTED_DATA: rsmi_status_t = rsmi_status_t::Err(rsmi_error::r#UNEXPECTED_DATA);
    const ERROR_BUSY: rsmi_status_t = rsmi_status_t::Err(rsmi_error::r#BUSY);
    const ERROR_REFCOUNT_OVERFLOW: rsmi_status_t =
        rsmi_status_t::Err(rsmi_error::r#REFCOUNT_OVERFLOW);
    const ERROR_SETTING_UNAVAILABLE: rsmi_status_t =
        rsmi_status_t::Err(rsmi_error::r#SETTING_UNAVAILABLE);
    const ERROR_AMDGPU_RESTART_ERR: rsmi_status_t =
        rsmi_status_t::Err(rsmi_error::r#AMDGPU_RESTART_ERR);
    const ERROR_DRM_ERROR: rsmi_status_t = rsmi_status_t::Err(rsmi_error::r#DRM_ERROR);
    const ERROR_UNKNOWN_ERROR: rsmi_status_t = rsmi_status_t::Err(rsmi_error::r#UNKNOWN_ERROR);
}
