...
define amdgpu_kernel void @bmsk_clamp_b32(ptr addrspace(4) byref(i64) %"40", ptr addrspace(4) byref(i64) %"41") #1 {
...
"39":                                             ; preds = %1
  ...
  %"60" = call i32 @__zluda_ptx_impl_bmsk_clamp_b32(i32 %8, i32 %9)
  store i32 %"60", ptr addrspace(5) %"46", align 4
