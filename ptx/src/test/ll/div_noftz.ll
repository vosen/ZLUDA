...
define amdgpu_kernel void @div_noftz(ptr addrspace(4) byref(i64) %"69", ptr addrspace(4) byref(i64) %"70") #1 {
...
"63":                                             ; preds = %1
  ...
  %"41" = getelementptr inbounds i8, ptr %"95", i64 4
  ...
  %"46" = extractvalue %struct.f32.f32.f32.i8 %12, 0
  %"47" = extractvalue %struct.f32.f32.f32.i8 %12, 1
  %"48" = extractvalue %struct.f32.f32.f32.i8 %12, 2
  %"49" = extractvalue %struct.f32.f32.f32.i8 %12, 3
  %13 = load float, ptr addrspace(5) %"73", align 4
  %14 = load float, ptr addrspace(5) %"74", align 4
  %"87" = call float @__zluda_ptx_impl_div_f32_part2(float %13, float %14, float %"46", float %"47", float %"48", i8 %"49")
  ...
  %"43" = getelementptr inbounds i8, ptr %"97", i64 4
