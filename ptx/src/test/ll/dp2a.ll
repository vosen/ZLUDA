...
define amdgpu_kernel void @dp2a(ptr addrspace(4) byref(i64) %"43", ptr addrspace(4) byref(i64) %"44") #1 {
...
"42":                                             ; preds = %1
  ...
  %"68" = call i32 @__zluda_ptx_impl_dp2a_hi_s32_s32(i32 %10, i32 %11, i32 %12)
