define amdgpu_kernel void @ld_st(ptr addrspace(4) byref(i64) %"36", ptr addrspace(4) byref(i64) %"37") #0 {
...
"35":                                             ; preds = %1
  ...
  %5 = load i64, ptr %"47", align 8
  store i64 %5, ptr addrspace(5) %"40", align 8
  %6 = load i64, ptr addrspace(5) %"39", align 8
  %7 = load i64, ptr addrspace(5) %"40", align 8
  %"48" = inttoptr i64 %6 to ptr
