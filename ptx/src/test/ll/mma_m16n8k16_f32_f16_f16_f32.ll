...
define amdgpu_kernel void @mma_m16n8k16_f32_f16_f16_f32(ptr addrspace(4) byref(i64) %"76") #1 {
...
"74":                                             ; preds = %"73"
  ...
  %15 = insertelement <2 x half> poison, half %14, i32 1
  %16 = fptrunc float %13 to half
  %"165" = insertelement <2 x half> %15, half %16, i32 0
  %"118" = bitcast <2 x half> %"165" to i32
  ...
  %20 = insertelement <2 x half> poison, half %19, i32 1
  %21 = fptrunc float %18 to half
  %"166" = insertelement <2 x half> %20, half %21, i32 0
  %"121" = bitcast <2 x half> %"166" to i32
  ...
  %25 = insertelement <2 x half> poison, half %24, i32 1
  %26 = fptrunc float %23 to half
  %"167" = insertelement <2 x half> %25, half %26, i32 0
  %"124" = bitcast <2 x half> %"167" to i32
  ...
  %30 = insertelement <2 x half> poison, half %29, i32 1
  %31 = fptrunc float %28 to half
  %"168" = insertelement <2 x half> %30, half %31, i32 0
  %"127" = bitcast <2 x half> %"168" to i32
  ...
  %35 = insertelement <2 x half> poison, half %34, i32 1
  %36 = fptrunc float %33 to half
  %"169" = insertelement <2 x half> %35, half %36, i32 0
  %"130" = bitcast <2 x half> %"169" to i32
  ...
  %40 = insertelement <2 x half> poison, half %39, i32 1
  %41 = fptrunc float %38 to half
  %"170" = insertelement <2 x half> %40, half %41, i32 0
  %"133" = bitcast <2 x half> %"170" to i32
