define amdgpu_kernel void @mul24_lo_u32(ptr addrspace(4) byref(i64) %"37", ptr addrspace(4) byref(i64) %"38") #0 {
...
"36":                                             ; preds = %1
  ...
  %"47" = call i32 @llvm.amdgcn.mul.u24.i32(i32 %6, i32 %7)
...
declare i32 @llvm.amdgcn.mul.u24.i32(i32, i32) #1
