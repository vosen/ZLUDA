...
define amdgpu_kernel void @prmt_slow(ptr addrspace(4) byref(i64) %"42", ptr addrspace(4) byref(i64) %"43") #1 {
...
"41":                                             ; preds = %1
  ...
  %"66" = call i32 @__zluda_ptx_impl_prmt_b32(i32 %10, i32 %11, i32 %12)
