...
"28":
  ...
  %"15" = select i1 false, i16 %"16", i16 %"17"
  store i16 %"15", ptr addrspace(5) %"6", align 2
  %"18" = load i64, ptr addrspace(5) %"5", align 8
  %"19" = load i16, ptr addrspace(5) %"6", align 2
  %"27" = inttoptr i64 %"18" to ptr
  store i16 %"19", ptr %"27", align 2
  ret void
}
