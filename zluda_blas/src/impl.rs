...
pub(crate) unsafe fn set_pointer_mode(handle: &Handle, mode: rocblas_pointer_mode) -> rocblas_status {
    rocblas_set_pointer_mode(handle.handle, mode)
}

pub(crate) unsafe fn set_pointer_mode_v2(handle: &Handle, mode: rocblas_pointer_mode) -> rocblas_status {
    rocblas_set_pointer_mode(handle.handle, mode)
}
